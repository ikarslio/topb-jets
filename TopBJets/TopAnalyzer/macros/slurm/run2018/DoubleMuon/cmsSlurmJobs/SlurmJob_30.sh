...
echo 'cd outfiles6 && g++ `root-config --cflags --glibs` -lGenVector DNNInput6.C ConstrainedFit.cc -o fit6 && ./fit6'
cd outfiles6 && g++ `root-config --cflags --glibs` -lGenVector DNNInput6.C ConstrainedFit.cc -o fit6 && ./fit6