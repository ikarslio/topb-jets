...
echo 'cd outfiles9 && g++ `root-config --cflags --glibs` -lGenVector DNNInput9.C ConstrainedFit.cc -o fit9 && ./fit9'
cd outfiles9 && g++ `root-config --cflags --glibs` -lGenVector DNNInput9.C ConstrainedFit.cc -o fit9 && ./fit9