...
echo 'cd outfiles7 && g++ `root-config --cflags --glibs` -lGenVector DNNInput7.C ConstrainedFit.cc -o fit7 && ./fit7'
cd outfiles7 && g++ `root-config --cflags --glibs` -lGenVector DNNInput7.C ConstrainedFit.cc -o fit7 && ./fit7