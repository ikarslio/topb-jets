...
echo 'cd outfiles4 && g++ `root-config --cflags --glibs` -lGenVector DNNInput4.C ConstrainedFit.cc -o fit4 && ./fit4'
cd outfiles4 && g++ `root-config --cflags --glibs` -lGenVector DNNInput4.C ConstrainedFit.cc -o fit4 && ./fit4