...
echo 'cd outfiles2 && g++ `root-config --cflags --glibs` -lGenVector DNNInput2.C ConstrainedFit.cc -o fit2 && ./fit2'
cd outfiles2 && g++ `root-config --cflags --glibs` -lGenVector DNNInput2.C ConstrainedFit.cc -o fit2 && ./fit2