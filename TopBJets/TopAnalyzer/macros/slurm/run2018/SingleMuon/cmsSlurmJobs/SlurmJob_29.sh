...
echo 'cd outfiles5 && g++ `root-config --cflags --glibs` -lGenVector DNNInput5.C ConstrainedFit.cc -o fit5 && ./fit5'
cd outfiles5 && g++ `root-config --cflags --glibs` -lGenVector DNNInput5.C ConstrainedFit.cc -o fit5 && ./fit5