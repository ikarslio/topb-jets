...
echo 'cd outfiles3 && g++ `root-config --cflags --glibs` -lGenVector DNNInput3.C ConstrainedFit.cc -o fit3 && ./fit3'
cd outfiles3 && g++ `root-config --cflags --glibs` -lGenVector DNNInput3.C ConstrainedFit.cc -o fit3 && ./fit3