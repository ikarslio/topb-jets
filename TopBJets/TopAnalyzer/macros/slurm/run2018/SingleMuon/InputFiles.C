...
void InputFiles() {
  ...
  std::ofstream file1(base+"1/infile1.txt"),   file2(base+"2/infile2.txt"),   file3(base+"3/infile3.txt"),
                ...
                file22(base+"22/infile22.txt"),file23(base+"23/infile23.txt"),file24(base+"24/infile24.txt");
  int count = 0;
  string line;
  while(getline(infile,line)) {
    ...
    if(count > 2100 && count < 2201) file22<<line<<"\n";
    if(count > 2200 && count < 2301) file23<<line<<"\n";
    if(count > 2300 && count < 2401) file24<<line<<"\n";
  }
}
