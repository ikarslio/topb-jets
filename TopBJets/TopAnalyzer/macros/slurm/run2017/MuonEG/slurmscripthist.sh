...
echo 'g++ `root-config --cflags --glibs` -lGenVector DataYield.C ConstrainedFit.cc -o fit && ./fit'
g++ `root-config --cflags --glibs` -lGenVector DataYield.C ConstrainedFit.cc -o fit && ./fit 
