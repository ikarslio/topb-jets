...
config.General.requestName     = 'se_run2017F'
...
config.JobType.pyCfgParams = ['era=2017', 'samplename=data', 'mode=se', 'datasetName=SingleElectron', 'outputFile=se_run2017F.root']
config.JobType.allowUndistributedCMSSW = True
...
config.Data.outLFNDirBase = '/store/user/rchawla/crab/20230731/se_run2017F'
