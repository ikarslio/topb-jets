...
config.General.requestName     = 'smu_run2017F'
...
config.JobType.pyCfgParams = ['era=2017', 'samplename=data', 'mode=smu', 'datasetName=SingleMuon', 'outputFile=smu_run2017F.root']
config.JobType.allowUndistributedCMSSW = True
...
config.Data.outLFNDirBase = '/store/user/rchawla/crab/20230731/smu_run2017F'
