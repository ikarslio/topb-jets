...
if __name__ == '__main__':
    ...
    parser.add_argument('--Tier2-prefix', dest='Tier2_prefix', action='store', default='srm://dcache-se-cms.desy.de:8443/srm/managerv2?SFN=',
                        help='prefix of the Tier-2 storage site')
...
#                      continue
                  ...
                  for i_tmp in range(len(exp_output_files_tmp)):
                      ...
                      TIER2_CP_CMD = 'gfal-copy -t 9999 -T 9999'
                      # https://github.com/cms-sw/cmssw/issues/26462
                      # https://github.com/grid-control/grid-control/issues/73
                      #EXE('(eval `scram unsetenv -sh`; '+TIER2_CP_CMD+' '+exp_output_files_tmp[i_tmp]+' "'+opts.Tier2_prefix+exp_output_files[i_tmp]+'"'+')', verbose=opts.verbose)
