...
config.General.requestName     = 'emu_run2017F'
...
config.JobType.pyCfgParams = ['era=2017', 'samplename=data', 'mode=emu', 'datasetName=MuonEG', 'outputFile=emu_run2017F.root']
config.JobType.allowUndistributedCMSSW = True
...
config.Data.outLFNDirBase = '/store/user/rchawla/crab/20230731/emu_run2017F'
