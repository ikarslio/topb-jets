...
config.General.requestName     = 'ee_run2018B'
...
config.JobType.pyCfgParams = ['era=2018', 'samplename=data', 'mode=ee', 'datasetName=EGamma', 'outputFile=ee_run2018B.root']
config.JobType.allowUndistributedCMSSW = True
...
config.Data.outLFNDirBase = '/store/user/rchawla/crab/20230731/ee_run2018B'
