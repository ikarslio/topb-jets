...
config.General.requestName     = 'emu_run2018A'
...
config.JobType.pyCfgParams = ['era=2018', 'samplename=data', 'mode=emu', 'datasetName=MuonEG', 'outputFile=emu_run2018A.root']
config.JobType.allowUndistributedCMSSW = True
...
config.Data.outLFNDirBase = '/store/user/rchawla/crab/20230731/emu_run2018A'
