...
config.General.requestName     = 'smu_run2018D'
...
config.JobType.pyCfgParams = ['era=2018', 'samplename=data', 'mode=smu', 'datasetName=SingleMuon', 'outputFile=smu_run2018D.root']
config.JobType.allowUndistributedCMSSW = True
...
config.Data.outLFNDirBase = '/store/user/rchawla/crab/20230731/smu_run2018D'
