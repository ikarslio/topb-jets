...
config.General.requestName     = 'mumu_run2017C'
...
config.JobType.pyCfgParams = ['era=2017', 'samplename=data', 'mode=mumu', 'datasetName=DoubleMuon', 'outputFile=mumu_run2017C.root']
config.JobType.allowUndistributedCMSSW = True
...
config.Data.outLFNDirBase = '/store/user/rchawla/crab/20230731/mumu_run2017C'
