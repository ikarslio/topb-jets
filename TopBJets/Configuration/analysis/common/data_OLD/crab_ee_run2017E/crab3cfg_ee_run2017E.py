...
config.General.requestName     = 'ee_run2017E'
...
config.JobType.pyCfgParams = ['era=2017', 'samplename=data', 'mode=ee', 'datasetName=DoubleEG', 'outputFile=ee_run2017E.root']
config.JobType.allowUndistributedCMSSW = True
...
config.Data.outLFNDirBase = '/store/user/rchawla/crab/20230731/ee_run2017E'
